...
// 자바 21 부터 가능
public class SwitchEnumExample3 {
    // 인터페이스 Drawable 로 그룹핑된 enum 타입을 레이블로 사용
    ...
    // 인터페이스 Drawable 로 그룹핑된 enum 타입의 상수를 레이블로 사용
    ...
    // 인터페이스 Drawable 로 그룹핑된 enum 타입과 상수를 혼용해서 레이블로 사용
